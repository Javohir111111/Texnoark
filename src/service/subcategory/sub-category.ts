...
export interface StoreSubCategory {
    ...
    dataSubCatigory:any[];
    totlCount:number;
    getDataSubCategory: (data:GetCategory)=> Promise <any>;
    postDataSubCategory: (data:postCategory)=> Promise <any>;
    deleteDataSubCategory: (id:number)=> Promise <any>;
    updateDataSubCategory: (data:UpdateCategory)=> Promise <any>;
}
