...
import { subCategory , StoreSubCategory } from '../../service/subcategory/sub-category';
...
const useSubCategoryStore = create <StoreSubCategory> ((set)=>({
    ...
    postDataSubCategory: async(data)=>{
    ...
    deleteDataSubCategory: async(id)=>{
        try{
    ...
    updateDataSubCategory: async(data)=>{
            try{
